...
if (!defined('WRITEPATH')) {
    define('WRITEPATH', realpath(rtrim($paths->writable_directory, '\/ ')) . DIRECTORY_SEPARATOR);
}
...
Services::autoloader()->load_helpers();
/*
 * ---------------------------------------------------------------
...
if (!is_file(COMPOSER_PATH)) {
    ...
    if ($missing_extensions !== []) {
        throw Framework_Exception::for_missing_extension(implode(', ', $missing_extensions));
    }
 ...
 * ---------------------------------------------------------------
 */
Services::autoloader()->initialize_kint(CI_DEBUG);
exit(1);