...
use Code_Igniter\Security\Check_Php_Ini;
/**
 * Check php.ini values.
 */
final class Php_Ini_Check extends Base_Command
{
    /**
     ...
     */
    protected $arguments = ['opcache' => 'Check detail opcache values in production environment.'];
    /**
    ...
    public function run(array $params)
    {
        ...
        Check_Php_Ini::run(argument: $argument);
        return EXIT_SUCCESS;
    }
}